  ...
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen
        ...
        component={UserReportsListScreen}
      />
      <Stack.Screen
        name="UserAddReportScreen"
        component={UserAddReportScreen}
      />
      <Stack.Screen
        name="UserAccidentsListScreen"
        component={UserAccidentsListScreen}
      />
      <Stack.Screen
        name="UserAddAccidentScreen"
        component={UserAddAccidentScreen}
      />
    </Stack.Navigator>
  );
}
