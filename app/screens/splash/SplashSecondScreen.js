  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerView}>
        ...
        <AppText style={[styles.text, { color: "#fff" }]}>امن</AppText>
      </View>
      <View style={styles.view}>
        <View style={styles.contentView}>
          <Image
            resizeMode="stretch"
            style={styles.image}
            source={require("../../assets/splash_screen/splash-2.png")}
          />
      ...
      <View style={styles.footer}>
        <AppButton
        onPress={() => {
          props.navigation.navigate('SplashFirstScreen')
        }}
          viewStyle={{
        ...
        <AppButton
        onPress={() => {
          props.navigation.navigate('SplashThirdScreen')
        }}
          viewStyle={{
