  ...
  return (
    <View style={styles.textView}>
      ...
      <View style={styles.questionAnswerView}>
        ...
        />
        <MaterialCommunityIcons name="forum" size={30} color={colors.green} />
      </View>
    </View>
  )
}
          ...
          <ScrollView style={styles.scrollViewStyle}>
            <View style={styles.headerView}>
              <View
                style={[
                  styles.statusView,
                  { backgroundColor: colors.errorRed + '44' },
                ]}
              >
                <AppText
                  style={[styles.statusText, { color: colors.errorRed }]}
                >
                  تاخیر
                </AppText>
              </View>
              <AppText w={'b'} style={styles.headerText}>
                پروژه برج مروارید
              </AppText>
            </View>
            ...
            <View style={styles.sendPhotoAndAudio}>
            ...
            <View style={styles.sendPhotoAndAudio}>
              ...
              <View style={styles.uploadAudioView}>
                <MaterialCommunityIcons
                  ...
                  color={colors.yellow}
                />
                <AppText style={styles.uploadAudioText}>
                  برای ضبط صدا روی میکروفون نگه دارید
                </AppText>
              </View>
            </View>
          </ScrollView>
