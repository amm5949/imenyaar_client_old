...
exports.LayersControl =
  exports.useLayersControl =
  exports.useLayersControlElement =
    void 0;
...
const useLayersControlElement = (0, _core.createElementHook)(
...
function createControlledLayer(addLayerToControl) {
  return function ControlledLayer(props) {
    ...
    const addLayer = (0, _react.useCallback)(
      (layerToAdd) => {
    ...
    const removeLayer = (0, _react.useCallback)(
      (layerToRemove) => {
        layersControl == null
          ? void 0
