...
exports.SVGOverlay =
  exports.useSVGOverlay =
  exports.useSVGOverlayElement =
    void 0;
...
const useSVGOverlayElement = (0, _core.createElementHook)(
...
function SVGOverlayComponent({ children, ...options }, ref) {
  ...
  return container == null || children == null
    ? null
    : /*#__PURE__*/ (0, _reactDom.createPortal)(children, container);
}
