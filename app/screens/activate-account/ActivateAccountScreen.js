    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <View style={styles.bothButtonContainer}>
          <AppText
            style={type === "gold" ? styles.lowColorPreviosButton : styles.highColorPreviosButton}
          >
            قبلی
          </AppText>
          <CircularIcon
            ...
            color={colors.yellow}
            style={type === "gold" ? styles.lowColorButtonStyle : styles.highColorButtonStyle}
          />
        </View>
        <View style={styles.bothButtonContainer}>
          <CircularIcon
            ...
            color={colors.yellow}
            style={ type === "bronze" ? styles.lowColorButtonStyle : styles.highColorButtonStyle}
          />
          <AppText
            style={type === "bronze" ? styles.lowColorPreviosButton : styles.highColorPreviosButton}
          >
            بعدی
          </AppText>
        </View>
